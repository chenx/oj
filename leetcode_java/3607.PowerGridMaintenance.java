// DFS/BFS + Priority Queue
// From https://leetcode.com/problems/power-grid-maintenance/editorial/
...
Note: The power grid preserves its structure; an offline (non‑operational) node remains part of its grid and taking it offline 
