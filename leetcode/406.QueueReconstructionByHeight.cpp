// From: https://leetcode.com/problems/queue-reconstruction-by-height/editorial/
// Time complexity : O(N2). To sort people takes O(NlogN) time. Insertion needs up to O(k=0∑N−1​k) time, i.e. up to O(N^2) time.
...
public:
    vector<vector<int>> reconstructQueue(vector<vector<int>>& people) {
        ...
        // sort by ASC order of k-value in [h, k]
