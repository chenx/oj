// From: https://leetcode.com/problems/count-binary-substrings/editorial/
// Time Complexity: O(N), where N = s.length(). Every loop is through O(N) items with O(1) work inside the for-block.
// Space: O(1)
class Solution {
public:
