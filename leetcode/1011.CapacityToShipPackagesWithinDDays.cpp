// From: https://leetcode.com/problems/capacity-to-ship-packages-within-d-days/editorial/
// The container capacity will be between max(weights), sum(weights)
// Perform Binary search on the container capacity
//
class Solution {
public:
